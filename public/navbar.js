...
function isAdmin(){
return props.user.email=='admin@mit.edu';
}
  props.user;
  return (
    <>
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
         ...
         {!isAdmin() && !isEmptyObject(props.user) ?
          ...
          {!isEmptyObject(props.user) ?
           <Nav>
          <button type="submit" id='logout' className="btn btn-light float-right" onClick={logOut} >
          Logout
        </button><p style={{ color: "green" }}><b>{props.user && props.user.email} </b> </p>
          </Nav> : null}
          {/* <Nav>
