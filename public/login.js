...
function Login(props){
  ...
  return (
    <Card bg="info" border="info" style={{ width: "20rem" }}>
       ...
       { 
         show ? (
          <LoginForm setUser={props.setUser} setShow={setShow} setStatus={setStatus} />
           ...
           <LoginMsg setUser={props.setUser} setShow={setShow} setStatus={setStatus} />
         )
      }
      </Card.Body>
    </Card>
...
<div>
    <button type="submit" className="btn btn-light" onClick={handleEmailSignIn} >Login</button>
    <button type="submit" className="btn btn-light float-right" onClick={handleGoogleSignIn}>Google Login</button>
    </div>
  </>);
}
}
